            ...
            permissionDocs.forEach(async (doc) => {
                ...
                if ((doc.data().from <= formattedDate) && (doc.data().to >= formattedDate)) {
                    ...
                    classDocs.forEach((indoc) => {
                        ...
                        console.log(doc.data().regno , value , pdvalue);
                        indoc.ref.update({
        ...
        return new Promise((resolve, reject) => {
            ...
            db.collection('StudentLogin')
                ...
                .then((userDocs) => {
                    ...
                    return db.collection('HOD-' + branch)
    ...
    function second() {
        return new Promise((resolve, reject) => {
            ...
            db.collection('StudentLogin')
                ...
                .then((indocs) => {
                    var temp = '<!DOCTYPE html> <html> <!-- rest of your HTML --> </html>';
                    indocs.forEach((indoc) => {
                        if (indoc.data().AG == "0") {
                            var A = "sb";
                        ...
                        temp = temp + '<br> <div> <center> <!-- rest of your HTML --> </center> </div>';
                    });
    ...
    function one() {
        return new Promise((resolve, reject) => {
            ...
            db.collection(req.query.inuser)
                ...
                .get()
                .then((docs) => {
                    const deletePromises = docs.map((doc) => doc.ref.delete());
